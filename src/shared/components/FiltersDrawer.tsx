...
export default function FiltersDrawer({open, handleDrawerChange}: FilterDrawerProps) {
    ...
    <Drawer
      ...
      <Grid container >
        <Grid item xs={12} md={4} sx={{ p: 3 }}>
          ...
          <Button size='small' fullWidth variant='contained' onClick={handleFilter}>Buscar</Button>
