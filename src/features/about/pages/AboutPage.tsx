    ...
    <Page title='Acerca de nosotros | Vision Inmobiliaria' description='Seccion de contacto'>
      <>
        ...
        <Typography variant='h2' align='center' sx={{my: 3}}>
          Profesionales con más de veinte años de <br/>experiencia
        </Typography>
          ...
          <Grid container spacing={2} sx={{my: 7}}>
            ...
            <Grid item xs={12} md={6}>
              <Typography px={2} fontSize='17px'>
                ...
                profesionales con más de veinte años de experiencia en el sector. Actualmente gestionamos el patrimonio
                inmobiliario de particulares, entidades financieras y fondos de inversión, ya sea residencial, comercial
                y terciario. También realizamos operaciones de Sale & Lease back. Disponemos de profesionales altamente
                cualificados para ofrecer a nuestros clientes seguridad y profesionalidad ante cualquier proyecto
                inmobiliario. Nuestro trabajo consiste en proporcionar a nuestros clientes el tipo de activo que más se
                ajuste a sus intereses. Ofrecemos nuestros servicios tanto a particulares, empresas y fondos de
                inversión, adecuando cada tipo de operación a las preferencias y capacidad de cada uno.
              </Typography>
            </Grid>
          </Grid>
