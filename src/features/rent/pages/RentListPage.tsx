...
import rentBanner from "@/assets/images/rent/rent-banner.jpg";
import {
  Box,
  Container,
  Grid,
...
function BannerComponent({item}: any) {
  ...
  return (
    ...
    >
      ...
      >
        <Typography variant='h1' align='center' color='#fff' sx={{letterSpacing: '3px'}}>Alquila con
          nosotros</Typography>
        ...
        <Container>
          <Grid container columnSpacing={5} rowSpacing={2} sx={{my: 3}}
            ...
            <Grid item container spacing={2} xs={12} md={8}>
              <Grid item xs={12}>
                <Typography align={'center'} variant='h3'>14 Inmuebles en alquiler</Typography>
              </Grid>
